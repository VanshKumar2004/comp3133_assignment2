...
const RootQuery = new GraphQLObjectType({
    ...
    fields: {
        ...
        searchEmployees: {
            ...
            async resolve(_, { department, designation }) {
                const query = {};
                if (department) {
        ...
        // Optional legacy resolver – remove if not needed
...
// Mutation with login and signup moved into it
